...
export const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm("service_4w0j404", "template_ca1hx73", form.current, {
        publicKey: "umMKSYCRGRw2FAwqI",
      })
      e.target.reset();
    //   .then(
    //     () => {
          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <span className="contact_card-data">
                akashsinghas9504@gmail.com
              </span>

              <a
                href="mailto:akashsinghas9504@gmail.com"
            ...
            <div className="contact_card">
              ...
              <span className="contact_card-data">8877350979</span>
